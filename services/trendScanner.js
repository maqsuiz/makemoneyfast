...
async function scanTrends() {
    const trends = [
        ...
        { topic: 'YouTube Shorts Monetization', platform: 'Google Trends', engagement: 45000, sentiment: 'Positive', velocity: 'Rising', money_angle: 'Generate Shorts with AI, earn ad revenue', related: ['Sora AI', 'video editing', 'content creation'], link: 'https://trends.google.com/trends/explore?q=youtube+shorts', category: 'content' },
